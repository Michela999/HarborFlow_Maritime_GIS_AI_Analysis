...
* `01_ais_eda.ipynb` *(previously `phase1_ais_eda.ipynb`)*

### Weather Analysis

* `01_weather_eda.ipynb` *(previously `phase1_weather_eda.ipynb`)*

### Maintenance Analysis

* `01_maintenance_eda.ipynb` *(previously `phase1_maintenance_eda.ipynb`)*  
* `maintenance_data_generation.ipynb` *(previously `maintenance_proxy.ipynb`)*
...
2. Spatial Join with Natural Earth Ports → `AIS_points_with_Port_final`
...
* EDA notebooks (renamed for clarity)  
